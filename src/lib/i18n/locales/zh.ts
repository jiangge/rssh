...
const zh: Messages = {
  ...
  "highlight.keyword_placeholder": "ERROR / WARN / 自定义模式",
  // 录制
  ...
  "github.pull": "从 GitHub 拉取",
  "github.set_password": "设置加密密码",
  "github.enter_password": "输入解密密码",
  "github.password": "密码",
  "github.confirm_password": "确认密码",
  "github.saved": "设置已保存",
  "github.password_empty": "密码不能为空",
  "github.password_mismatch": "两次密码不一致",
  "github.push_ok": "推送成功",
  "github.pull_ok": "拉取成功",
  "github.failed": "失败：{error}",
  // 导入 / 导出
